          ...
          <BlogSection>
            <div id={props.elements[index]['id']}>
              <div className="blog-image">
                {props.elements[index]['imageUrl'] ?  <img src={props.elements[index]['imageUrl']} width='800' height='600'/> : null}
              </div>
              ...
              <div className="blog__footer">
                <p>Ha tetszett, kerlek oszd meg a Facebookon is:</p>
                <FacebookShareButton url={`www.fodorzsana.hu/${props.elements[index]['url']}`}>
